    ...
    <>
      ...
      <div className="sidebar displayflex">
        <ul className="nav flex-column">
          ...
          <li className="nav-item textdesign" textdesign>
      ...
      <div className="content">
        <div className='float_prop colours'>
          ...
          <div className="input-group mb-3 textbox">
            ...
            <input type="text" className="form-control" placeholder="Enter text" id="messageInp" />
            <button className="btn btn-primary" type="button" id="myButton">Send</button>
